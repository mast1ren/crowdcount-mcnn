...
for blob in data_loader:                        
    ...
    print('\r[{:>{}}/{}] img: {}, error: {}, gt: {}, pred: {}'.format(i, len(str(data_loader.num_samples)), data_loader.num_samples, os.path.basename(img_path), abs(gt_count-et_count), gt_e, pred_e), end='')
    i+=1
    if vis:
